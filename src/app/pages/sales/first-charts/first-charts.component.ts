...
export class ChartsSalesComponent implements OnInit {
  ...
  ngOnInit(): void {
    ...
    this.updateRevenueTrendChart(); // Initialize empty chart first
    this.GetDailyRevenueChart();

    // ================================  Weekly Performance (الأداء الأسبوعي) ============================
    this.weeklyPerformanceData = [];
    this.updateWeeklyPerformanceChart(); // Initialize empty chart first
    this.loadWeeklyPerformanceChart();

    // ================================  Lead Status (حالة العميل) ====================================
    // Initialize with empty array, will be populated from API
    this.leadStatusData = [];
    this.updateLeadStatusChart(); // Initialize empty chart first
